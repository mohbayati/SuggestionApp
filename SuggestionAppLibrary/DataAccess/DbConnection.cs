...
public class DbConnection : IDbConnection
{
    ...
    public DbConnection(IConfiguration configurarion)
    {
        _configurarion = configurarion;
        Client = new MongoClient(_configurarion.GetConnectionString(_connectionId));
        DbName = _configurarion["DatabaseName"];
